...
public class BookController {
    ...
    public ResponseEntity<GetBookDto> getById(
            @Valid
    ...
    public ResponseEntity<GetBookDto> getBookByBookName(
            @Valid
            @PathVariable("book-name")
            String bookName
    ) {
    ...
    public ResponseEntity<GetBookByCategory> getBookByCategory(
            @Valid
            @PathVariable("book-id")
            Integer bookId
    ) {
